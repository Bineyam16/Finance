...
export class MyTaskService {
  ...
  private IsLockedBy_OtherUserUrl = environment.rootPath + 'BPEL/IsLockedBy_OtherUser';  // URL to web api
  ...
  IsLockedBy_OtherUser(todoid) {
    return this.http.get(this.IsLockedBy_OtherUserUrl + '?todoid=' + todoid + '&Username='  + environment.username);
  }
  getSupervisertasks() {
    return this.http.get(
